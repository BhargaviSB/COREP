    ...
    addDownloadButtonListener: function () {
        ...
        downloadButton.addEventListener('click', () => { 
          ...
          for (var i = 0; i < rows.length; i++) {
            ...
            var note = [{v: "* All values reported are in millions", t: "s", s: {font: {name: "Calibri", sz: 10}, fill: {patternType: "solid", fgColor: {rgb: "FFFFFF"}, bgColor: {rgb: "A9AAAB"}}, border: {bottom: {style: "medium"}, right: {style: "medium"}}}}];
