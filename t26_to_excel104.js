    ...
    addDownloadButtonListener: function (k) {
      ...
      downloadButton.addEventListener('click', () => { 
        ...
        // });
          ...
          var tdata = "<tr class='table-header'><th class='table-header' rowspan='1' colspan='100' style='align-items: left;text-align: left; height: 40px;border: 1px solid black;background-color: #eee;font-family: Verdana;'><b>C 29.00 - Detail of the exposures to individual clients within groups of connected clients (LE 3)</b></th></tr><tr class='table-header'><th class='table-header' rowspan='1' colspan='3' style='background-color:none !important;font-family:Verdana;font-size:10px;align-items: center;text-align: right;padding: 5px;color:grey;font-weight:normal;'>* All values reported are in millions </th></tr>" + htmlTable;
          ...
          const header = [
            {v: "C 26.00 - Large Exposures limits (LE Limits)", t: "s", s: {font: {name: "Calibri", sz: 16, bold: true}, fill: {patternType: "solid", bgColor: {rgb: "a9aaab"}}, border: {bottom: {style: "medium"}}}}
          ];
          const note = [
        ...
        //   var wsheet = XLSX.utils.table_to_sheet(tdata, {origin: 'A4'});
          var wsheet = XLSX.utils.sheet_add_dom(tdata, {origin: 'A1'});
